      ...
      <div className="border-t border-b border-foreground/10 py-5 space-y-4">
        <div className="flex items-center gap-3">
          ...
          <p className="text-sm text-foreground/80">
            <span className="font-semibold">{Math.max(participants.length, 2)} people</span> are in the waiting room, ready to have a discussion with you in <span className="font-semibold"><SessionTimer format="mins" /></span>!
          </p>
        </div>
